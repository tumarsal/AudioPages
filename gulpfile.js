...
/*gulp.task('template', function () {
    return gulp.src('app/html/content/*.html')
      .pipe(template('app/html/template/template.html'))
      .pipe(gulp.dest('app'));
});*/
...
gulp.task('watch', function() {
	...
	gulp.watch('app/html2/content/*.html', gulp.parallel('template'));
	gulp.watch('app/html2/template/*.html', gulp.parallel('template'));

	gulp.watch('app/img/_src/**/*', gulp.parallel('img'));
});
gulp.task('default', gulp.parallel('img','template', 'styles', 'scripts', 'browser-sync', 'watch'));
